...
def offer_create(request):
    ...
    if request.method == 'POST':
        ...
        created_by_username = request.user
        ...
        offer = Offer.objects.create(customer=customer, created_by=created_by_username,date=date, sub_total=sub_total, tax=tax, total=total)
